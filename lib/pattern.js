        ...
        Pattern: function Pattern (kind) {
            ...
            if ('atom' === this.kind) {
                ...
                if ('seq' === this.kind) {
                    ...
                    this.duration = function () {
                        return _.reduce(this.children, function (maxDuration, child) {
                ...
                if ('atom' === this.kind) {
                    ...
                    _.each(children, function adjustDurations (seqOfAtoms) {
                        ...
                        _.each(seqOfAtoms.children, function (atom) {
                            atom.atomDuration = lcmDuration / oldDuration;
                        });
                    });
            ...
            this.toString = function () {
                if ('atom' === this.kind) {
                    ...
                    for (var d = 1; d < this.atomDuration; ++d) {
                        arr.push('^');
                    }
                    return arr.join(' ');
                } else if ('seq' === this.kind) {
